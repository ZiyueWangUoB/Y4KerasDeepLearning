...
train_data_dirA = 'unbiasedShear/shear2Point5/A'
train_data_dirB = 'unbiasedShear/shear2Point5/B'
train_data_dirC = 'unbiasedShear/shear2Point5/C'
...
def transfer_model():
    ...
    old_model = load_model('validationNoAug/2.5/best_model.h5')
